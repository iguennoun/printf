...
/**
* get_width - Get the specified width when printing numbers
*		It's usefull in printing tables
*		because small and large number both took
*		the same amount of space
* @format: The string in which to print the arguments
* @i: Nbr of arguments to be printed
* @list: List of arguments
*
* Return: integer of the specified with or 0
*/
